...
import com.apgsga.maven.dm.ext.DmBombAnalyzersExtension
import com.apgsga.maven.dm.tasks.DmBomReportTask
...
internal fun Project.apgDmBombReportExt(): DmBombAnalyzersExtension =
        extensions.getByName(EXTENSION_NAME) as? DmBombAnalyzersExtension
                ?: throw IllegalStateException("$EXTENSION_NAME is ncd ot of the correct type")