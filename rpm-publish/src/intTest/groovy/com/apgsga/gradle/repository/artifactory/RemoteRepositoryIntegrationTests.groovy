...
class RemoteRepositoryIntegrationTests extends Specification {
	...
	private static final String TEST_REPO = "yumdigiflexsnaprepo"
	...
	def "publish to remote repo works"() {
		given:
			RemoteRepositoryBuilder builder = RemoteRepositoryBuilder.create(ARTIFACTORY_URL);
		...
		then:
			...
			deploy.repo == TEST_REPO
			deploy.uri ==   ARTIFACTORY_URL + "/" + TEST_REPO + "/" + TEST_RPM_NAME
	}
